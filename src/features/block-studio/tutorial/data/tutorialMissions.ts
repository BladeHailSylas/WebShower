...
export const tutorialMissions = [
  ...
  },
  {
    ...
    description: "소개 구역 안에 제목 블록을 넣어 보세요.",
    condition: { type: "hasNestedBlockInNamedContainer", containerName: "소개 구역", childType: "H1" },
    commentOnSuccess:
  ...
  },
  {
    ...
    commentOnSuccess: "화면에 보이는 글자는 HTML 요소의 내용으로 저장됩니다.",
  },
  {
    id: "add-intro-paragraph",
    title: "소개 문장을 넣어 보세요",
    description: "소개 구역 안에 문단 블록을 추가해 보세요.",
    condition: { type: "hasNestedBlockInNamedContainer", containerName: "소개 구역", childType: "P" },
    commentOnSuccess:
  ...
  },
  {
    ...
    condition: { type: "hasNestedBlockInNamedContainer", containerName: "소개 구역", childType: "IMAGE" },
  ...
  },
  {
    ...
    condition: { type: "hasStyleChangedInNamedContainer", containerName: "소개 구역", styleKey: "paddingSize" },
    commentOnSuccess:
  ...
  },
  {
    ...
    description: "카드 안에 제목을 넣어 보세요.",
    instantSuccess: false,
    comment: "'내가 좋아하는 것들' 같은 내용으로 채워볼까요?",
  ...
  },
  {
    ...
    title: "목록을 만들어 보세요",
    description: "좋아하는 것들을 정리할 수 있게, 카드 구역 안에 목록 블록을 추가해 보세요.",
    condition: {
      type: "hasStructure",
      parentType: "LIST",
  ...
  },
  {
    ...
    condition: { type: "hasStyleChangedInNamedContainer", containerName: "소개 구역", styleKey: "bgColor" },
    commentOnSuccess:
  ...
  },
  {
    ...
    commentOnSuccess:
      "미리보기는 블록으로 만든 페이지가 실제 화면에서 어떻게 보일지 보여줍니다.",
  },
  {
    id: "view-code",
...
export const promotionTutorialMissions = [
  ...
  {
    id: "promotion-name-hero-container",
    instantSuccess: false,
    title: "첫 구역 이름을 정해 보세요",
    description: "방금 만든 일반 구역의 이름을 ‘첫인상 구역’으로 바꿔 보세요.",
    comment: "구역 블록의 파란 단추를 누르면 스타일 창에서 구역 이름을 입력할 수 있어요.",
    condition: { type: "hasContainerNamed", containerName: "첫인상 구역" },
    commentOnSuccess: "첫인상 구역이라는 이름이 생겨서 다음 블록을 넣을 위치가 분명해졌습니다.",
  },
  {
    id: "promotion-add-heading",
    title: "홍보 제목을 넣어 보세요",
    description: "첫인상 구역 안에 제목 블록을 넣어, 무엇을 홍보하는 페이지인지 알려주세요.",
    condition: { type: "hasNestedBlockInNamedContainer", containerName: "첫인상 구역", childType: "H1" },
  ...
  },
  {
    ...
    description:
      "제목을 ‘우리 동아리를 소개합니다’ 또는 ‘함께 만드는 웹 제작 모임’처럼 바꿔 보세요.",
    comment: "원하는 내용이 있다면 그걸 대신 써도 괜찮아요!",
    condition: { type: "hasContentChanged", blockType: "H1" },
  ...
  },
  {
    ...
    description:
      "모임에 대해 설명할 수 있게 첫인상 구역 안에 문단 블록을 추가해주세요.",
    condition: { type: "hasNestedBlockInNamedContainer", containerName: "첫인상 구역", childType: "P" },
  ...
  },
  {
    ...
    condition: { type: "hasContentChanged", blockType: "P" },
    commentOnSuccess:
      "홍보 문장은 방문자가 계속 읽어 볼지 결정하는 중요한 단서가 됩니다.",
  },
  {
    id: "promotion-add-image",
    title: "대표 이미지를 추가해 보세요",
    description: "첫인상 구역에 이미지 블록을 추가해 페이지의 분위기를 보여주세요.",
    condition: { type: "hasNestedBlockInNamedContainer", containerName: "첫인상 구역", childType: "IMAGE" },
  ...
  },
  {
    ...
    comment: "이 url을 사용해보세요: https://loremflickr.com/400/200",
    condition: { type: "hasAttributeChanged", blockType: "IMAGE", field: "src" },
    commentOnSuccess: "img 태그는 src 속성에 적힌 주소에서 이미지를 불러옵니다.",
  },
  {
  ...
  {
    id: "promotion-name-benefits-container",
    instantSuccess: false,
    title: "장점 구역 이름을 정해 보세요",
    description: "새로 만든 일반 구역의 이름을 ‘장점 구역’으로 바꿔 보세요.",
    condition: { type: "hasContainerNamed", containerName: "장점 구역" },
    commentOnSuccess: "장점 구역이라는 이름 덕분에 Grid를 넣을 위치가 명확해졌습니다.",
  },
  {
    id: "promotion-add-grid",
    title: "장점을 나란히 배치해 보세요",
    description: "장점 구역 안에 바둑판 구역을 추가해 여러 정보를 나란히 보여줄 준비를 해 보세요.",
    condition: { type: "hasNestedBlockInNamedContainer", containerName: "장점 구역", childType: "GRID_ZONE" },
    commentOnSuccess: "바둑판 구역은 여러 정보를 같은 줄에 나란히 배치할 때 유용합니다.",
  },
  {
    id: "promotion-add-card-to-grid",
    title: "바둑판 구역 안에 카드를 넣어 보세요",
    description: "바둑판 구역 안에 카드를 추가해 장점 하나를 담을 공간을 만들어 보세요.",
    condition: { type: "hasNestedBlockInNamedContainer", containerName: "장점 구역", childType: "CARD" },
    commentOnSuccess: "이렇게 하면 여러 정보를 일정한 칸으로 정리할 수 있습니다.",
  },
  {
    ...
    title: "카드에 내용을 넣어주세요",
    description:
      "모임의 장점을 써넣을 수 있게, 카드 안에 제목이나 문단을 넣어주세요.",
    comment: "‘함께 배워요’, ‘직접 만들어요’ 같은 내용도 써 보세요!",
    condition: { type: "hasAddedNestedBlock", parentType: "CARD", childType: "H1" },
    commentOnSuccess: "카드는 하나의 장점이나 정보를 짧게 묶어 보여줄 때 좋습니다.",
  },
  {
  ...
  },
  {
    ...
    description: "활동 안내를 작성할 수 있게, 원하는 곳에 목록을 넣어 보세요.",
    instantSuccess: false,
    comment: "목록 항목 안에 제목이나 문단을 넣어, 안내문을 직접 작성해봐도 됩니다.",
    condition: {
      type: "hasStructure",
      parentType: "LIST",
      directChildType: "LIST_ITEM",
  ...
  },
  {
    ...
    description: "방문자가 궁금해할 질문을 모아 둘 새 일반 구역을 추가해 보세요.",
    condition: { type: "hasAddedBlock", blockType: "CONTAINER", min: 3 },
    commentOnSuccess:
      "이 구역은 자주 묻는 질문을 미리 정리해 방문자의 궁금증을 줄여 주는 구역으로 씁시다.",
  },
  {
    id: "promotion-name-faq-container",
    instantSuccess: false,
    title: "FAQ 구역 이름을 정해 보세요",
    description: "새로 만든 일반 구역의 이름을 ‘FAQ 구역’으로 바꿔 보세요.",
    condition: { type: "hasContainerNamed", containerName: "FAQ 구역" },
    commentOnSuccess: "FAQ 구역이라는 이름을 기준으로 질문 블록을 넣을 수 있습니다.",
  },
  {
    id: "promotion-add-faq-toggle",
    title: "접었다 펼칠 수 있는 질문을 만들어 보세요",
    description:
      "FAQ 구역에 여닫는 구역을 추가해 질문과 답변을 접었다 펼칠 수 있게 만들어 보세요.",
    condition: { type: "hasNestedBlockInNamedContainer", containerName: "FAQ 구역", childType: "TOGGLE_ZONE" },
    commentOnSuccess: "여닫는 구역은 열기 버튼을 클릭했을 때 숨겨진 내용을 보여주는 신기한 블록입니다.",
  },
  {
    id: "promotion-edit-faq-answer",
    instantSuccess: false,
    title: "FAQ 답변을 수정해 보세요",
    description: "여닫는 구역 안에 문단을 각각 하나씩 넣어보세요.",
    comment: "그리고 답변 내용을 실제 질문에 맞게 바꿔보세요!",
    condition: { type: "hasAddedNestedBlock", parentType: "TOGGLE_ZONE", childType: "P" },
    commentOnSuccess:
      "방문자가 궁금해할 내용을 미리 답해 주면 홍보 페이지가 더 친절해집니다.",
  },
  {
...
export const invitationTutorialMissions = [
  {
    ...
    condition: { type: "hasAddedBlock", blockType: "CONTAINER" },
    commentOnSuccess:
      "구역은 초대장의 제목, 설명, 이미지 같은 내용을 하나로 묶어 줍니다.",
  },
  {
    id: "invitation-name-main-container",
    instantSuccess: false,
    title: "초대장 구역 이름을 정해 보세요",
    description: "방금 만든 일반 구역의 이름을 ‘초대장 구역’으로 바꿔 보세요.",
    comment: "구역 블록의 파란 단추를 누르면 스타일 창에서 구역 이름을 입력할 수 있어요.",
    condition: { type: "hasContainerNamed", containerName: "초대장 구역" },
    commentOnSuccess: "이제 초대장 구역을 기준으로 제목, 문장, 이미지를 확인할 수 있습니다.",
  },
  {
    id: "invitation-add-heading",
    title: "초대 제목을 넣어 보세요",
    description: "초대장 구역 안에 제목 블록을 넣어 보세요.",
    condition: { type: "hasNestedBlockInNamedContainer", containerName: "초대장 구역", childType: "H1" },
  ...
  },
  {
    ...
    condition: { type: "hasNestedBlockInNamedContainer", containerName: "초대장 구역", childType: "P" },
  ...
  },
  {
    ...
    condition: { type: "hasNestedBlockInNamedContainer", containerName: "초대장 구역", childType: "IMAGE" },
  ...
  {
    id: "invitation-name-details-container",
    instantSuccess: false,
    title: "행사 안내 구역 이름을 정해 보세요",
    description: "새로 만든 일반 구역의 이름을 ‘행사 안내 구역’으로 바꿔 보세요.",
    condition: { type: "hasContainerNamed", containerName: "행사 안내 구역" },
    commentOnSuccess: "행사 안내 구역이라는 이름을 기준으로 날짜와 장소 정보를 정리할 수 있습니다.",
  },
  {
  ...
  },
  {
    ...
    condition: { type: "hasStyleChangedInNamedContainer", containerName: "초대장 구역", styleKey: "bgColor" },
    commentOnSuccess:
  ...
  },
  {
    ...
    condition: { type: "hasStyleChangedInNamedContainer", containerName: "초대장 구역", styleKey: "paddingSize" },
    commentOnSuccess:
      "안쪽 여백은 CSS의 padding입니다. 내용과 테두리 사이에 숨 쉴 공간을 만들어 줍니다.",
  },
  {
